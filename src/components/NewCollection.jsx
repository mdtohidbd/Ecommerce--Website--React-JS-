...
const NewCollection = () => {
  ...
  return (
    <div>
        <div className='mx-auto max-w-2xl px-4 py-16 sm:pt-24 lg:max-w-7xl lg:px-8  shadow-lg bg-yellow-50 rounded-lg'>
            <h2 className='text-4xl font-bold tracking-tight text-gray-900 text-center font-serif'><span className=' font-bold text-pink-600'>New</span> Collection</h2>
