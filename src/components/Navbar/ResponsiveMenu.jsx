...
const ResponsiveMenu = ({ showMenu, setShowMenu }) => {
    return (
        <div className={`${showMenu ? "left-0" : "-left-[100%]"} fixed bottom-0 top-0 z-20 flex h-screen w-[70%] flex-col justify-between bg-red-100 px-8 pb-6 pt-16 text-black md:hidden rounded-r-xl shadow-md`}>
            <div>
